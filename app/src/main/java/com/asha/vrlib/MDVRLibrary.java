...
public class MDVRLibrary {
    ...
    public void switchBarrelDistortionConfig(BarrelDistortionConfig barrelDistortionConfig){
        mDisplayModeManager.setBarrelDistortionConfig(barrelDistortionConfig);
        mDisplayModeManager.setAntiDistortionEnabled(barrelDistortionConfig.isDefaultEnabled());
    }
