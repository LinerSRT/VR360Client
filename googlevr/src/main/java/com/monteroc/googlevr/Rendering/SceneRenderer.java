...
public final class SceneRenderer {
    ...
    @MainThread
    public static SceneRenderer createForVR(Context context, ViewGroup parent) {
        CanvasQuad canvasQuad = new CanvasQuad();
        SceneRenderer scene = new SceneRenderer(canvasQuad, new Handler(Looper.getMainLooper()), null);
        return scene;
    }
